...
class AuthHandler:
    ...
    async def _validate_userid_login(
        ...
        #     if identifier == "email":
        #         return "@yeasin:myChatserver"

        # print("the type of pool", type(DatabasePool))
        qualified_user_id = await self.store.get_users_ID(username)
        # qualified_user_id = await AuthHandler(hs=self.hs).get_user_ID(
        #     identifier=username
        # )
